...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/ablokker/LiquidFloatingActionButton"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Alex Blokker" => "blokkmaster@gmail.com" }
  s.source           = { :git => "https://github.com/ablokker/LiquidFloatingActionButton.git", :tag => s.version.to_s }
